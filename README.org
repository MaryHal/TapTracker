...
Another patch (=patch/tgm2p_psikyosh.diff=) will modify TGM2+'s framerate to the correct ~61.681 hz. The file to-be-patched is at $MAME/src/mame/drivers/psikyosh.c.
